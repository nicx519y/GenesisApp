...
const events = [
  ...
  ["worldo_map_click", "点击旧版 worldo map 任意位置", "GenesisTelemetry.collectLog", "event", "worldo_map_click", "oid", "", "", "OriginDetail.oid"],
  ["worldo_tilemap_click", "点击 Tilemap 版 worldo map 任意位置", "GenesisTelemetry.collectLog", "event", "worldo_tilemap_click", "oid", "", "", "OriginDetail.oid"],
  ...
  ["world_map_click", "点击旧版 world map 任意位置", "GenesisTelemetry.collectLog", "event", "world_map_click", "wid", "", "", "WorldPage.widget.wid"],
  ["world_tilemap_click", "点击 Tilemap 版 world map 任意位置", "GenesisTelemetry.collectLog", "event", "world_tilemap_click", "wid", "", "", "WorldPage.widget.wid"],
