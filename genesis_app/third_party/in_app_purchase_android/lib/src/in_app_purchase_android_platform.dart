...
class InAppPurchaseAndroidPlatform extends InAppPurchasePlatform {
  ...
  /// Launches a billing flow and preserves the native response details.
  ///
  /// This is needed by callers that must distinguish a rejected launch from
  /// a successfully opened Play purchase UI.
