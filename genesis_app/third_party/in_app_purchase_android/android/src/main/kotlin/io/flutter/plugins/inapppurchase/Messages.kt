...
)
 {
  companion object {
    fun fromList(pigeonVar_list: List<Any?>): PlatformOneTimePurchaseOfferDetails {
      ...
      val offerId = pigeonVar_list[3] as String?
      val offerToken = pigeonVar_list[4] as String?
      val purchaseOptionId = pigeonVar_list[5] as String?
      return PlatformOneTimePurchaseOfferDetails(priceAmountMicros, formattedPrice, priceCurrencyCode, offerId, offerToken, purchaseOptionId)
    }
  }
  fun toList(): List<Any?> {
    return listOf(
  ...
  override fun equals(other: Any?): Boolean {
    ...
    return MessagesPigeonUtils.deepEquals(this.priceAmountMicros, other.priceAmountMicros) && MessagesPigeonUtils.deepEquals(this.formattedPrice, other.formattedPrice) && MessagesPigeonUtils.deepEquals(this.priceCurrencyCode, other.priceCurrencyCode) && MessagesPigeonUtils.deepEquals(this.offerId, other.offerId) && MessagesPigeonUtils.deepEquals(this.offerToken, other.offerToken) && MessagesPigeonUtils.deepEquals(this.purchaseOptionId, other.purchaseOptionId)
  }
  ...
  override fun hashCode(): Int {
    ...
    result = 31 * result + MessagesPigeonUtils.deepHash(this.purchaseOptionId)
    return result
  }
}
