...
class SearchV1Api extends V1ApiResource {
  ...
  /// Response:
  /// ```json
  /// {"err_no":0,"err_msg":"succ","data":{"keyword":"string","type":"","origins":{"list":[{"origin_id":"o_1","origin_name":"Origin","origin_version":"1","brief":"","language":"en","cover":{},"tags":["fantasy"],"characters":[{"character_id":"c_1","name":"Alice"}],"owner":{},"stats":{},"matches":[{"field":"tag","tag_index":0,"highlight_ranges":[{"start":0,"length":3}]}],"matches_truncated":false}],"total":0,"pn":1,"rn":3},"worlds":{"list":[{"world_id":"w_1","world_name":"World","origin_id":"o_1","language":"en","cover":{},"tags":["fantasy"],"owner":{},"stats":{},"created_at":0,"matches":[{"field":"tag","tag_index":0,"highlight_ranges":[{"start":0,"length":3}]}]}],"total":0,"pn":1,"rn":3},"users":{"list":[{"uid":"u_1","name":"User","avatar":{},"matches":[{"field":"user_name","highlight_ranges":[{"start":0,"length":4}]}]}],"total":0,"pn":1,"rn":3}}}
  /// ```
