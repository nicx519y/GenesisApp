...
class GenesisSemanticColors extends ThemeExtension<GenesisSemanticColors> {
  ...
  factory GenesisSemanticColors.worldoDark() {
    return const GenesisSemanticColors(
      ...
      // Six dark text tiers, 2026-08-22 spec. Pure white is reserved for bar
      // titles; content titles and spoken lines sit on soft white.
      textPrimary: GenesisPalette.redesignSoftWhite,
      textHighEmphasis: GenesisPalette.redesignSoftWhite,
      foregroundStrong: GenesisPalette.white,
      immersiveForeground: GenesisPalette.white,
      textHeading: GenesisPalette.redesignSoftWhite,
      textStrong: GenesisPalette.redesignSoftWhite,
      textBody: GenesisPalette.redesignWhite73,
      textCinematic: GenesisPalette.redesignWhite73,
      textQuaternary: GenesisPalette.redesignWhite56,
      textMuted: GenesisPalette.redesignWhite56,
      textSecondary: GenesisPalette.redesignWhite56,
      ...
      dividerSubtle: GenesisPalette.redesignWhite06,
      ...
      // Idle nav sits on the 32% tier with the other disabled states.
      navigationUnselected: GenesisPalette.redesignWhite32,
      scrim: GenesisPalette.black,
