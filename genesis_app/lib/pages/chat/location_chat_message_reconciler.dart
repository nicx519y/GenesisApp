...
@visibleForTesting
Map<String, String> locationChatRoleAvatarsByIdForTesting({
  required Iterable<Map<String, dynamic>> characters,
  ...
  return _locationChatRoleAvatarsById(
    characters: characters,
    characterPositions: characterPositions,
...
ChatStoryEventParagraphVm? locationChatStoryEventParagraphVmForTesting(
  ...
  Map<String, String> roleAvatarsById = const <String, String>{},
}) {
  return parseLocationChatStoryEventParagraph(
    ...
    roleAvatarUrl: (id) => roleAvatarsById[_chatroomIdentityKey(id)] ?? '',
  );
}
