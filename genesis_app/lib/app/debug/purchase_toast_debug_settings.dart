...
final purchaseToastDebugSettings = PurchaseToastDebugSettingsController();

class PurchaseToastDebugSettingsController {
  static const String storageKey = 'developer_purchase_toast_debug_details_v1';
  ...
  Future<void> _save(bool enabled) async {
    ...
    if (!saved) {
      throw StateError('Failed to save the purchase toast debug setting.');
    }
  }
