...
usage() {
  cat <<'EOF'
Usage:
  scripts/create_release_tag.sh android [--push] [--dry-run]
  scripts/create_release_tag.sh ios [--push] [--dry-run]
...
Examples:
  scripts/create_release_tag.sh android
  scripts/create_release_tag.sh ios --push
